 ...
 * @author Cognizant
 */
public class WebDriversFac {
	private static Properties properties;

	private WebDriversFac() {
	...
	public static WebDriver getWebDriver(Browser browser) {
		...
		case GHOST_DRIVER:
			...
			/*
			 * case INTERNET_EXPLORER: // Takes the system proxy settings automatically
			 * 
			 ...
			 * true); driver = new InternetExplorerDriver(ieCapabilities); break;
			 * 
			 * case OPERA: // Does not take the system proxy settings automatically! // NTLM
			 * authentication for proxy NOT supported
			 * 
			 * if (proxyRequired) { DesiredCapabilities desiredCapabilities =
			 * getProxyCapabilities(); driver = new OperaDriver(desiredCapabilities); } else
			 * { driver = new OperaDriver(); }
			 * 
			 * break;
			 * 
			 * case SAFARI: // Takes the system proxy settings automatically
			 * 
			 * driver = new SafariDriver(); break;
			 * 
			 * case HTML_UNIT: driver=new HtmlUnitDriver(); break;
			 */
	...
	public static WebDriver getRemoteWebDriver(Browser browser, String browserVersion, Platform platform,
		...
		/*
		 * if (browser.equals(Browser.OPERA) && proxyRequired) { desiredCapabilities =
		 * getProxyCapabilities(); } else {
		 */
